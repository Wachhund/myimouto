Post = {
  ...
  flag: function(id, finished) {
    ...
    var html = '<div id="flag-dialog-overlay">' +
      '<div class="flag-dialog">' +
        '<h3>Flag Post</h3>' +
        '<div class="flag-dialog-field">' +
          '<label for="flag-category">Category:</label>' +
          '<select id="flag-category" class="flag-dialog-input">';
    ...
    html += '</select></div>' +
        '<div id="flag-reason-wrap" class="flag-dialog-field" style="display:none;">' +
          '<label for="flag-reason">Reason:</label>' +
          '<textarea id="flag-reason" rows="3" class="flag-dialog-input"></textarea>' +
        '</div>' +
        '<div id="flag-parent-wrap" class="flag-dialog-field" style="display:none;">' +
          '<label for="flag-parent-id">Parent Post ID:</label>' +
          '<input type="text" id="flag-parent-id" class="flag-dialog-input" />' +
        '</div>' +
        '<div class="flag-dialog-actions">' +
          '<button id="flag-cancel-btn" type="button">Cancel</button>' +
          '<button id="flag-submit-btn" type="button" disabled="disabled">Submit</button>' +
        '</div>' +
      '</div></div>';
