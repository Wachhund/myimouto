...
class ForumTopicSubscription extends Rails\ActiveRecord\Base
{
     ...
     */
    static public function subscribe($user_id, $topic_id)
    {
     ...
     */
    static public function unsubscribe($user_id, $topic_id)
    {
     ...
     */
    static public function is_subscribed($user_id, $topic_id)
    {
     ...
     */
    static public function mark_read($user_id, $topic_id)
    {
        $sub = self::where('user_id = ? AND forum_topic_id = ?', (int)$user_id, (int)$topic_id)->first();
        if ($sub) {
