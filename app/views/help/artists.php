<div class="help">
  ...
  <div class="section">
    ...
    <p>Start at the <?= $this->linkTo("index", "artist#index") ?>. In addition to browsing through the entire artist list, you can also search for artists.</p>
  ...
  <div class="section">
    ...
    <p>First off, <?= $this->linkTo("go here", "artist#create") ?>.</p>
  ...
  <div class="section">
    ...
    <p>Yes. The artist controller uses the same interface as the rest of Danbooru. See the <?= $this->linkTo("API documentation", "help#api") ?> for details.</p>
  </div>
</div>
