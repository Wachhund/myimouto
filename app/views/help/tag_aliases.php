<div class="help">
  ...
  <p>When a tag is aliased to another tag, that means that the two tags are equivalent. You would not generally alias <code>rectangle</code> to <code>square</code>, for example, because while all squares are rectangles, not all rectangles are squares. To model this sort of relationship, you would need to use <?= $this->linkTo("implications", "#tag_implications") ?>.</p>
